...
namespace PDF4Dev
{
    public partial class ComponentsClient
    {
        ...
        private static readonly global::PDF4Dev.EndPointSecurityRequirement s_DeleteComponentSecurityRequirement0 =
        ...
        private static readonly global::PDF4Dev.EndPointSecurityRequirement[] s_DeleteComponentSecurityRequirements =
            new global::PDF4Dev.EndPointSecurityRequirement[]
            {                s_DeleteComponentSecurityRequirement0,
            };
        partial void PrepareDeleteComponentArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string id);
        partial void PrepareDeleteComponentRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string id);
        partial void ProcessDeleteComponentResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessDeleteComponentResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::PDF4Dev.DeleteComponentResponse> DeleteComponentAsync(
            string id,
            global::PDF4Dev.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await DeleteComponentAsResponseAsync(
                id: id,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::PDF4Dev.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::PDF4Dev.AutoSDKHttpResponse<global::PDF4Dev.DeleteComponentResponse>> DeleteComponentAsResponseAsync(
            string id,
            global::PDF4Dev.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareDeleteComponentArguments(
            ...
            var __authorizations = global::PDF4Dev.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_DeleteComponentSecurityRequirements,
                operationName: "DeleteComponentAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::PDF4Dev.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::PDF4Dev.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "DeleteComponentAsync",
                                pathTemplate: "$\"/api/v1/components/{id}\"",
                                httpMethod: "DELETE",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessDeleteComponentResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::PDF4Dev.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessDeleteComponentResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::PDF4Dev.DeleteComponentResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::PDF4Dev.AutoSDKHttpResponse<global::PDF4Dev.DeleteComponentResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::PDF4Dev.DeleteComponentResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
