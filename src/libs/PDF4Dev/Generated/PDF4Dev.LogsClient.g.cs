...
{
    /// <summary>
    /// View PDF generation history. Each render (success or error) is logged with duration, file size, and metadata. Requires `full_access` API key scope.<br/>
    /// If no httpClient is provided, a new one will be created.<br/>
    /// If no baseUri is provided, the default baseUri from OpenAPI spec will be used.
    /// </summary>
    public sealed partial class LogsClient : global::PDF4Dev.ILogsClient, global::System.IDisposable
    {
        /// <summary>
        /// Current server
        /// </summary>
        ...
        internal global::System.Lazy<global::System.Text.Json.Serialization.JsonSerializerContext> JsonSerializerContextProvider { get; set; } = new(() => global::PDF4Dev.LogsSourceGenerationContext.Default);
