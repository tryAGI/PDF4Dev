...
namespace PDF4Dev
{
    public partial class TemplatesClient
    {
        ...
        private static readonly global::PDF4Dev.EndPointSecurityRequirement s_DuplicateTemplateSecurityRequirement0 =
        ...
        private static readonly global::PDF4Dev.EndPointSecurityRequirement[] s_DuplicateTemplateSecurityRequirements =
            new global::PDF4Dev.EndPointSecurityRequirement[]
            {                s_DuplicateTemplateSecurityRequirement0,
            };
        partial void PrepareDuplicateTemplateArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string id);
        partial void PrepareDuplicateTemplateRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string id);
        partial void ProcessDuplicateTemplateResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessDuplicateTemplateResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);

        /// <summary>
        /// Duplicate a template<br/>
        /// Creates a copy of the template with "(copy)" appended to its name. Requires `full_access` API key scope.
        /// </summary>
        /// <param name="id"></param>
        /// <param name="requestOptions">Per-request overrides such as headers, query parameters, timeout, retries, and response buffering.</param>
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::PDF4Dev.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::PDF4Dev.Template> DuplicateTemplateAsync(
            string id,
            global::PDF4Dev.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await DuplicateTemplateAsResponseAsync(
                id: id,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::PDF4Dev.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::PDF4Dev.AutoSDKHttpResponse<global::PDF4Dev.Template>> DuplicateTemplateAsResponseAsync(
            string id,
            global::PDF4Dev.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareDuplicateTemplateArguments(
            ...
            var __authorizations = global::PDF4Dev.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_DuplicateTemplateSecurityRequirements,
                operationName: "DuplicateTemplateAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareDuplicateTemplateRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::PDF4Dev.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::PDF4Dev.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "DuplicateTemplateAsync",
                                pathTemplate: "$\"/api/v1/templates/{id}/duplicate\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessDuplicateTemplateResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::PDF4Dev.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessDuplicateTemplateResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::PDF4Dev.Template.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::PDF4Dev.AutoSDKHttpResponse<global::PDF4Dev.Template>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::PDF4Dev.Template.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
