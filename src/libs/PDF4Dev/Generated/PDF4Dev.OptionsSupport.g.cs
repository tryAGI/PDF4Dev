...
namespace PDF4Dev
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::PDF4Dev.AutoSDKRetryOptions Retry { get; set; } = new global::PDF4Dev.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::PDF4Dev.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::PDF4Dev.IAutoSDKHook>();
        ...
        public global::PDF4Dev.AutoSDKClientOptions AddHook(
            global::PDF4Dev.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::PDF4Dev.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::PDF4Dev.AutoSDKClientOptions UseAuthorizationProvider(
            global::PDF4Dev.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::PDF4Dev.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::PDF4Dev.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::PDF4Dev.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::PDF4Dev.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::PDF4Dev.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::PDF4Dev.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::PDF4Dev.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::PDF4Dev.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::PDF4Dev.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::PDF4Dev.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::PDF4Dev.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::PDF4Dev.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::PDF4Dev.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::PDF4Dev.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::PDF4Dev.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::PDF4Dev.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
            ...
            global::PDF4Dev.AutoSDKClientOptions clientOptions,
            global::PDF4Dev.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::PDF4Dev.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::PDF4Dev.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::PDF4Dev.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::PDF4Dev.AutoSDKClientOptions clientOptions,
            global::System.Func<global::PDF4Dev.IAutoSDKHook, global::PDF4Dev.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::PDF4Dev.AutoSDKHookContext context)
        {
