...
namespace PDF4Dev
{
    public partial class ComponentsClient
    {
        ...
        private static readonly global::PDF4Dev.EndPointSecurityRequirement s_UpdateComponentSecurityRequirement0 =
        ...
        private static readonly global::PDF4Dev.EndPointSecurityRequirement[] s_UpdateComponentSecurityRequirements =
            new global::PDF4Dev.EndPointSecurityRequirement[]
            {                s_UpdateComponentSecurityRequirement0,
            };
        partial void PrepareUpdateComponentArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string id,
            global::PDF4Dev.UpdateComponentRequest request);
        partial void PrepareUpdateComponentRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string id,
            global::PDF4Dev.UpdateComponentRequest request);
        partial void ProcessUpdateComponentResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessUpdateComponentResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::PDF4Dev.Component> UpdateComponentAsync(
            string id,
        ...
        {
            var __response = await UpdateComponentAsResponseAsync(
                id: id,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::PDF4Dev.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::PDF4Dev.AutoSDKHttpResponse<global::PDF4Dev.Component>> UpdateComponentAsResponseAsync(
            string id,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareUpdateComponentArguments(
            ...
            var __authorizations = global::PDF4Dev.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_UpdateComponentSecurityRequirements,
                operationName: "UpdateComponentAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::PDF4Dev.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::PDF4Dev.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "UpdateComponentAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessUpdateComponentResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::PDF4Dev.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessUpdateComponentResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::PDF4Dev.Component.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::PDF4Dev.AutoSDKHttpResponse<global::PDF4Dev.Component>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::PDF4Dev.Component.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::PDF4Dev.Component> UpdateComponentAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::PDF4Dev.UpdateComponentRequest
            {
                Name = name,
                Type = type,
                Html = html,
