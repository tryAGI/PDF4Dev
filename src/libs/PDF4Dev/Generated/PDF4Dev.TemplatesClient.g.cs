...
{
    /// <summary>
    /// CRUD operations for HTML templates. Templates support Handlebars `{{variables}}` and can be referenced by ID or slug in render requests. Requires `full_access` API key scope.<br/>
    /// If no httpClient is provided, a new one will be created.<br/>
    /// If no baseUri is provided, the default baseUri from OpenAPI spec will be used.
    /// </summary>
    public sealed partial class TemplatesClient : global::PDF4Dev.ITemplatesClient, global::System.IDisposable
    {
        /// <summary>
        /// Current server
        /// </summary>
